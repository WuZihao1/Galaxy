...
bool loadOBJ_test(const char * path, std::vector<glm::vec3> & out_vertices, std::vector<glm::vec2> & out_uvs, std::vector<glm::vec3> & out_normals, glm::vec3 & max, glm::vec3 & min)
{
	printf("Loading OBJ file %s...\n", path);
